...
import { BloodRequest, BloodRequestPaginatedResponse, ExactLocation } from "../lib/definitions";
...
export default function Requests() {
    ...
    const handleRequests = (res: BloodRequestPaginatedResponse | { status: "error"; message: string; errors?: any }) => {
        ...
        <main className="min-h-screen bg-gray-50 dark:bg-gray-900">
            <div className="grid grid-cols-1 lg:flex justify-end w-full">
                ...
                <div className="h-full lg:w-1/2 flex flex-col bg-white dark:bg-gray-900 z-[300]">
                    ...
                    {/* Messages */}
                    {successMessage && (
                        <div className="mx-6 mt-6 bg-green-50 dark:bg-green-900 border border-green-200 dark:border-green-800 text-green-800 dark:text-green-200 px-4 py-3 rounded-lg" role="alert">
                    ...
                    {errorMessage && (
                        <div className="mx-6 mt-6 bg-red-50 dark:bg-red-900 border border-red-200 dark:border-red-800 text-red-800 dark:text-red-200 px-4 py-3 rounded-lg" role="alert">
                            <div className="flex items-center">
                                <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 20 20">
                                                ...
                                                <div className="flex-1">
                                                    ...
                                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                                        ...
                                                        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                                                            ...
                                                            <span>{request.date_time ? new Date(request.date_time).toLocaleString() : "ASAP"}</span>
                                                        </div>
                                                        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                                                            <span className="font-medium">Contact:</span>
                                                            <span className="font-mono">{request.contact_number}</span>
                                                        </div>
                                                        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                                                            <span className="font-medium">Location:</span>
                                                            <span>{request.exact_location || "Not specified"}</span>
                                                        </div>
                                                        <div className="flex items-center gap-2 text-gray-700 dark:text-gray-300">
                                                    ...
                                                    {request.verification_photo?.path && (
                                                        <div className="mt-4">
                                                            <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Verification Photo:</p>
                                                            <img
