            ...
            <div className="flex max-w-7xl mx-auto p-3 justify-center items-center">
                ...
                <form id="edit-form" onSubmit={(e) => {
                    ...
                    <div className="mb-5">
                        ...
                        {  data?.verification_photo && <img src={data?.verification_photo ? "http://localhost:8000/storage" + data?.verification_photo.path : ""} alt="Verification Photo" className="w-1/2" />}
