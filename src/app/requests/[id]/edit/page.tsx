...
import {
  ...
  updateRequestApplicationByFormData,
        ...
        >
          ...
          <div className="mb-5">
            ...
            <select
              ...
              onChange={(e) => {
                if (data) setData({ ...data, blood_type: e.target.value });
              }}
          ...
          <div className="mb-5">
            ...
            <input
              ...
              name="date_time"
              id="base-input"
              defaultValue={data?.date_time && data?.date_time.toLocaleString()}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
          </div>
          <div className="mb-5">
            ...
            <input
              ...
              name="exact_location"
              id="base-input"
              defaultValue={data?.exact_location}
              className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            />
          </div>
          <div className="mb-5">
          ...
          <div className="mb-5">
            ...
            <div className="flex items-center mb-1">
              <input
                id="default-checkbox"
                type="checkbox"
                defaultValue="verification_photo"
                className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
              />
              <label
                htmlFor="default-checkbox"
          ...
          <button
            type="submit"
            className="text-white bg-blue-700 hover:cursor-pointer hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800"
          >
            Update
          </button>
          <button
            ...
            className="mx-2 hover:cursor-pointer focus:outline-none text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900"
          >
            Delete
          </button>
        </form>
