  ...
  return (
    <>
      <div className="p-5 w-full">
        <form
          action={handleSubmit}
          className="mx-auto flex flex-col max-w-lg p-8 rounded-lg bg-gray-200 dark:bg-gray-800"
        >
          ...
          <button
            type="submit"
            className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 hover:cursor-pointer text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
          >
            Submit
          </button>
          {!isLoading && (
            <div className="flex justify-center py-2">
              <p className="newtothiswebsite content-center ps-1">
                Already have an account?
                <Link
                  href="/login"
                  className="text-red-600 hover:text-red-800 dark:text-red-400 dark:hover:text-red-200 ps-1"
                >
                  Login
                </Link>
              </p>
