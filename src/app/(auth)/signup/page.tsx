    ...
    return (
        <>
            <div className='p-5 w-full'>
                <form action={handleSubmit} className="mx-auto flex flex-col max-w-lg p-7 rounded-lg bg-white">
                    <div className="mb-5">
                    ...
                    <div className="mb-5">
                        ...
                        <input type="password" id="confirm-password" name='confirmPassword' className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5" required />
