  ...
  return (
    <div className="p-5 w-full">
      <form
        ...
        className="max-w-md mx-auto p-8 rounded-lg flex flex-col bg-gray-200 dark:bg-gray-800 border"
      >
        <h3 className="welcome-back text-3xl text-center text-red-600 dark:text-red-400 py-2">
          Welcome Back
        </h3>
        <p className="small-text-below-welcome-back text-sm text-center mb-5 pt-1 pb-3">
