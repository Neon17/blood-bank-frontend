...
export const deleteDonorApplication = asyncErrorHandler(
  _deleteDonorApplication
);
export const editDonorApplication = asyncErrorHandler(_editDonorApplication);
export const updateDonorApplication = asyncErrorHandler(
  _updateDonorApplication
);
export const myDonorApplication = asyncErrorHandler(_myDonorApplication);
export const approveBloodDonorApplication = asyncErrorHandler(
  _approveBloodDonorApplication
);

export const editRequestApplication = asyncErrorHandler(
  _editRequestApplication
);
export const updateRequestApplicationByFormData =
  asyncErrorHandler(_updateBloodRequest);
export const updateRequestApplication = asyncErrorHandler(
  _updateRequestApplication
);
export const myRequestApplication = asyncErrorHandler(_yourBloodRequest);
export const cancelRequestApplication = asyncErrorHandler(
  _cancelRequestApplication
);
export const completeRequestApplication = asyncErrorHandler(
  _completeRequestApplication
);
// Admin tasks of Request applications (below 2 lines)
export const approveRequestApplication = asyncErrorHandler(
  _approveRequestApplication
);
export const rejectRequestApplication = asyncErrorHandler(
  _rejectRequestApplication
);
...
async function _allBloodRequests($query = {}) {
  ...
  const data: BloodRequestPaginatedResponse | ErrorResponse =
    await response.data;
  return data;
}
...
async function _donorApplications($query = {}) {
  ...
  const data: BloodDonorsPaginatedResponse | ErrorResponse =
    await response.data;
  return data;
}
