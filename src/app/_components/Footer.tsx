        ...
        <footer className="bg-gray-300 dark:bg-gray-900">
            <div className="container mx-auto w-full p-4 py-6 lg:py-8">
                        ...
                        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-6">
                            <div>
                                ...
                                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                                    <li className="mb-4">
                                        <a href="#" className="hover:underline">Blood Bank</a>
                                    </li>
                                    <li>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="https://flowbite.com/" className="hover:underline">Blood Bank</a>. All Rights Reserved.
                    </span>
