                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="text-red-100 text-sm mb-4 max-w-xs">
                            Connecting blood donors with those in need. Your contribution can save lives.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-3">
                            <li>
                                <Link href="/donors" className="text-red-100 hover:text-white transition-colors duration-200 flex items-center">
                                    <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                                    Find Donors
                                </Link>
                            </li>
                            <li>
                                <Link href="/donate" className="text-red-100 hover:text-white transition-colors duration-200 flex items-center">
                                    <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                                    Become a Donor
                                </Link>
                            </li>
                            <li>
                                <Link href="/about" className="text-red-100 hover:text-white transition-colors duration-200 flex items-center">
                                    <span className="w-2 h-2 bg-white rounded-full mr-3"></span>
                                    About Us
                                </Link>
                            </li>
