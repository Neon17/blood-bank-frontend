                            ...
                            <ul className="font-medium flex flex-col items-center p-4 md:p-0 mt-4 border border-gray-100 rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0">
                                ...
                                <li>
                                    ...
                                    {user &&
                                        <>
                                            <div className="relative inline-block text-left">
                                                <button id="dropdownButton" onClick={() => { SetIsOpen(!IsOpen); console.log(IsOpen) }} className="px-4 py-2 text-blue-600 dark:text-blue-300 rounded-lg hover:text-blue-800 dark:hover:text-blue-400 hover:cursor-pointer">
                                                    {user.name}
                                                </button>
                                            </div>
                                        </>
                                    ...
                                    {IsOpen && <div id="dropdownMenu" className="absolute mt-2 border border-gray-200 bg-gray-300 dark:bg-gray-700 rounded-md shadow-lg z-1000">
