      ...
      {values.map((label, index) => {
        ...
        return (
          <div key={index} className="flex flex-col items-center z-10">
            ...
            {/* Label */}
            <span className="hidden md:block mt-2 text-sm text-center text-gray-700 dark:text-gray-300 whitespace-normal break-words max-w-[6rem] md:max-w-[10rem]leading-tight">
              {label}
            </span>
          </div>
        );
