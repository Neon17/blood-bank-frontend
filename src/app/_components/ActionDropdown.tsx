  ...
  return (
    <>
      <div className="dropdown-chevron p-0 m-0">
        <button
          className="inline-flex items-center px-3 py-2 hover:cursor-pointer text-sm font-medium text-white bg-gray-700 rounded-lg hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300"
        ...
        {open && (
          <div className="dropdown-menu flex flex-col absolute bg-gray-200 p-5">
            ...
            <form action={`/requests/finish`} method="post">
              ...
              <button
                type="submit"
                className="items-center px-5 py-2.5 me-2 mb-2 text-sm font-medium text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300"
              >
                Finish Request
              </button>
            </form>
