                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 h-[500px] lg:h-auto">
                        ...
                        <p className="text-gray-600 dark:text-gray-400 text-sm mb-4">
                            Set your current location to receive blood requests within your area
                        </p>
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            {/* Last Donation */}
                            <div className="space-y-2">
                                <label htmlFor="last_donation" className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                                    Last Donation Date
                                </label>
                                <input
                                    id="last_donation"
                                ...
                                {errors?.last_donated_date && (
                                    <p className="text-red-500 text-sm">{errors.last_donated_date}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                {errors?.medical_conditions && (
                                    <p className="text-red-500 text-sm">{errors.medical_conditions}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-2">
                                ...
                                {errors?.current_medication && (
                                    <p className="text-red-500 text-sm">{errors.current_medication}</p>
                                )}
                            </div>
                            ...
                            <div className="space-y-3">
                                ...
                                <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                                    {['excellent', 'good', 'fair', 'poor'].map(status => (
                                        <label key={status} className="flex items-center space-x-2 cursor-pointer p-3 border border-gray-200 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                                            <input
                                                type="radio"
                                                name="health_status"
                                                value={status}
                                ...
                                {errors?.current_health_status && (
                                    <p className="text-red-500 text-sm">{errors.current_health_status}</p>
                                )}
                            </div>
