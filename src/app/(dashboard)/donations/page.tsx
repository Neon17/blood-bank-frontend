...
import { myDonations, updateDonation, deleteDonation } from '@/app/lib/actions';
...
export default function MyDonationsPage() {
  ...
  const handleUpdate = async () => {
    ...
    if (res && 'message' in res) setError(res.message);
      ...
      setEditDonation(null);
      setSuccess(
        'Donation updated successfully! It will be reviewed by admin.'
      );
      fetchMyDonations();
    }
  };
          ...
          {donations.map((donation) => (
            ...
            >
              ...
              <div className="flex justify-between items-start mb-4">
                <div>
                  <span
                    className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getStatusColor(donation.verification_status)}`}
                  >
                    {donation.verification_status?.charAt(0).toUpperCase() +
                      donation.verification_status?.slice(1)}
                  </span>
                </div>
              ...
              <div className="px-6 py-4 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="mt-1 text-sm text-gray-900 dark:text-white">
                      {formatDate(viewDonation.date_time)}
                    </p>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">
                    ...
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium mt-1 ${getStatusColor(viewDonation.verification_status)}`}
                    >
            ...
            <div className="relative inline-block w-full max-w-4xl my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-800 shadow-xl rounded-2xl">
              <div className="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <p className="text-sm text-yellow-600 dark:text-yellow-400 mt-1">
                  Note: Updating this donation will require admin verification
                  again.
                </p>
              </div>
            ...
            <div className="relative inline-block w-full max-w-md my-8 overflow-hidden text-left align-middle transition-all transform bg-white dark:bg-gray-800 shadow-xl rounded-2xl">
              ...
              <div className="px-6 py-4">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Are you sure you want to delete your donation from{' '}
