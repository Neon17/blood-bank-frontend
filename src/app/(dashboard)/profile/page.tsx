...
import { Camera, MapPin, User, Mail, Calendar, Home, Droplets, CheckCircle, XCircle } from 'lucide-react';
    ...
    const InfoField = ({ icon: Icon, label, value }: { icon: any, label: string, value: string }) => (
        <div className="flex items-center space-x-3 p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <div className="flex-1 min-w-0">
                ...
                <p className="text-lg font-semibold text-gray-900 dark:text-white truncate">{value || 'Not provided'}</p>
            </div>
        </div>
    );
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div className="space-y-4">
                                ...
                                <InfoField icon={MapPin} label="Country" value={user.country || ''} />
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Donor Profile</span>
                                </Link>
                                <Link 
                                ...
                                >
                                    ...
                                    <span className="text-sm font-medium text-gray-700 dark:text-gray-300">Become Donor</span>
                                </Link>
                            </div>
                        </div>
                    </div>
