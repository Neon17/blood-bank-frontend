...
import { Heart, Users, MapPin, Droplets, AlertCircle, Calendar } from 'lucide-react';
        ...
        <div className="p-6 space-y-8">
            ...
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-6 text-white">
                ...
                <p className="text-red-100 opacity-90">
                    Ready to save lives today? Check nearby blood requests or schedule your next donation.
                </p>
            </div>
                    ...
                    {statCards.map(({ label, value, color, icon: Icon, description }) => (
                        ...
                        >
                            <div className="flex items-center justify-between">
                                ...
                                <div className={`p-3 rounded-full ${getColorClasses(color)} bg-opacity-20`}>
                ...
                <div className="space-y-3">
                    <div className="flex items-center space-x-3 p-3 bg-green-50 dark:bg-green-900/20 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400">2 days ago at City Blood Bank</p>
                        </div>
                    </div>
                    <div className="flex items-center space-x-3 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-600 dark:text-gray-400">Blood type O+ needed within 5km</p>
                        </div>
                    </div>
                </div>
            </div>
